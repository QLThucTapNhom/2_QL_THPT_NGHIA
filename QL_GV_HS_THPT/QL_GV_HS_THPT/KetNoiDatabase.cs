...
namespace QL_GV_HS_THPT
{
    ...
    {
        public static SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-G186E8N\SQLEXPRESS;Initial Catalog=HeThong_QuanLyHocTap;Integrated Security=True");
